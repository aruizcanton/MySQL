  ...
  loop
    ...
    loop
      ...
      then
        ...
        UTL_FILE.put_line(fich_salida_load, 'sh -x ${' || NAME_DM || '_CARGA}/' || nombre_fich_carga || ' ${FCH_DATOS} ${FCH_DATOS} ${BAN_FORZADO} > ${' || NAME_DM || '_TRAZAS}/' || nombre_fich_carga || '_${FCH_DATOS}_${BAN_FORZADO}.log 2>&' || '1');
      ...
      then
        ...
        UTL_FILE.put_line(fich_salida_exchange, 'sh -x ${' || NAME_DM || '_CARGA}/' || nombre_fich_carga || ' ${FCH_DATOS} ${FCH_DATOS} ${BAN_FORZADO} > ${' || NAME_DM || '_TRAZAS}/' || nombre_fich_carga || '_${FCH_DATOS}_${BAN_FORZADO}.log 2>&' || '1');
      ...
      loop
        ...
        then
          ...
          UTL_FILE.put_line(fich_salida_pkg, 'sh -x ${' || NAME_DM || '_CARGA}/' || nombre_fich_carga || ' ${FCH_DATOS} ${FCH_DATOS} ${BAN_FORZADO} > ${' || NAME_DM || '_TRAZAS}/' || nombre_fich_carga || '_${FCH_DATOS}_${BAN_FORZADO}.log 2>&' || '1');
